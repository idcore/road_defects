...
bag = load_bag('./rosbag2_2023_08_29-13_03_38_0.db3')


#meta.type 'sensor_msgs/msg/PointCloud2'
#meta.name '/lio_sam/deskew/cloud_deskewed'
...
bag.set_filter(rosbag2_py.StorageFilter(topics=["/points"]))
...
for _ in range(10):
    message = bag.read_next()
    #pc = pypcd.PointCloud.from_msg(message)
    #pts.append(pc)
    
    my_arr = read_points(deserialize_message(message[1], type_table[message[0]]), field_names = ['x','y','z','t'],skip_nans=True)
